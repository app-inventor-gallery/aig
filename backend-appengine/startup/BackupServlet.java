...
*/
    ...
    /**
     * Process a GET request. This is a request for a backup
     *
        ...
        throws IOException
    {
        ...
        fObj = this.__scope.get("doBackup", this.__scope);
        if (! (fObj instanceof Function))
        {
            // Failed to retrieve it
            java.lang.System.err.println("Could not retrieve doBackup");
        }
        else
        {
    ...
    /**
     * Process a POST request. This is a database restore.
     *
     * @param request {javax.servlet.http.HttpServletRequest}
     *   The object containing the request parameters.
     *
        ...
        throws IOException
    {
        ...
        // Retrieve the function object
        fObj = this.__scope.get("doRestore", this.__scope);
        if (! (fObj instanceof Function))
        {
            // Failed to retrieve it
            java.lang.System.err.println("Could not retrieve doRestore");
        }
        else
        {
            Object              args[] = { request, response };
