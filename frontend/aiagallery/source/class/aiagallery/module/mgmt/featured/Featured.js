 ...
 */
qx.Class.define("aiagallery.module.mgmt.featured.Featured",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.mgmt.featured.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.mgmt.featured.Gui.getInstance().buildGui(module);
    }
  }
});
