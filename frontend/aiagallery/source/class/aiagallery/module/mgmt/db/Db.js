 ...
 * User management
 */
qx.Class.define("aiagallery.module.mgmt.db.Db",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.mgmt.db.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.mgmt.db.Gui.getInstance().buildGui(module);
    }
  }
});
