 ...
 * Help page 
 */
qx.Class.define("aiagallery.module.dgallery.help.Help",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.help.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.help.Gui.getInstance().buildGui(module);
    }
  }
});
