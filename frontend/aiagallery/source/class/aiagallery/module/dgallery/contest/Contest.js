 ...
 * Contest page 
 */
qx.Class.define("aiagallery.module.dgallery.contest.Contest",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.contest.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.contest.Gui.getInstance().buildGui(module);
    }
  }
});
