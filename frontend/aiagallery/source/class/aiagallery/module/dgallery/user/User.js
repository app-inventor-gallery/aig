...
/**
 * User's Own Information page
 */
qx.Class.define("aiagallery.module.dgallery.user.User",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.user.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.user.Gui.getInstance().buildGui(module);
    }
  }
});
