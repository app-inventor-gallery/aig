...
qx.Class.define("aiagallery.module.dgallery.myapps.Gui",
{
  ...
  members :
  {
    ...
    buildGui : function(module)
    {
      ...
      scrollCanvas = new qx.ui.container.Composite(new qx.ui.layout.VBox());
      o.add(scrollCanvas);
      ...
      app.set(
        {
          title          : "Android Shell",
          description    : "Give yourself Linux access with this shell!",
          status         : 1,
          tags           : [ "Development", "shell" ],
          sourceFileName : "Android Shell.zip",
          numLikes       : 0,
          numDownloads   : 0,
          numViewed      : 0,
          numComments    : 0
      ...
      app.set(
        {
          title          : "Image Viewer",
          description    : "View all your images. Lots of fancy features.",
          status         : 2,
          tags           : [ "Graphics", "images", "viewer" ],
          sourceFileName : "ImageViewer.zip",
          numLikes       : 23,
          numDownloads   : 3,
          numViewed      : 4,
          numComments    : 5,
