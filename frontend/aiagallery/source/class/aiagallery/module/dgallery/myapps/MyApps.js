...
/**
 * Gallery "My Apps" Page
 */
qx.Class.define("aiagallery.module.dgallery.myapps.MyApps",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.myapps.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.myapps.Gui.getInstance().buildGui(module);
    }
  }
});
